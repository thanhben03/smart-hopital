...
@section('content_title',__("Danh Sách Hẹn Khám"))
...
@section('main_content')
    <div class="row">
        ...
        <div class="col-md-10">
            <form action={{route('searchDataCalendar')}} method="GET" role="search">
                @csrf
                ...
                <div class="callout callout-info">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            @if(request()->get('cat'))
                                <a href="/lich-hen" class="btn btn-warning mt-3">Quay lại</a>
    ...
    @if($search_result)
        @if(count($search_result) > 0)
            ...
            @foreach($search_result as $key => $patients)
                {{-- Search Results --}}
