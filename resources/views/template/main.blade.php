...
<head>
    ...
    <style>
        ...
        .date-group {
            ...
            border: 1px solid #ccc; /* Đường viền cho nhóm */
            padding: 10px; /* Khoảng cách bên trong nhóm */
            background-color: #f9f9f9; /* Màu nền cho nhóm */
        }

        .date-group h3 {
            margin: 0; /* Bỏ khoảng cách mặc định của tiêu đề */
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li
                        ...
                        <ul class="treeview-menu">
                            <li class="{{Active::checkRoute(['searchPatient','searchData'])}}">
                                <a
                                    href="{{route('searchData')}}"></i>
                                    <i class="fas fa-search" aria-hidden="true"></i>
                                    Danh sách chờ
                                </a>

                            </li>
                            <li class="{{Active::checkRoute(['searchDataCalendar'])}}">
                                <a
                                    href="{{route('searchDataCalendar')}}"></i>
