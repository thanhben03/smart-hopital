...
Route::post('/next-department', [PatientController::class, 'nextDepartment'])->name('patient.register');
// Auth Routes
...
Route::get('/patient/{stt}', [PatientController::class, 'done'])->middleware('auth', 'staff', 'lang')->name('patient.done');
...
Route::get('/danh-sach-cho', ['as' => 'searchData', 'uses' => 'PatientController@patientData'])->middleware('auth', 'staff', 'lang');
Route::get('/lich-hen', ['as' => 'searchDataCalendar', 'uses' => 'PatientController@listAppointment'])->middleware('auth', 'staff', 'lang');
